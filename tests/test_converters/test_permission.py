import pytest
import discord
from src.discord_template_manage.converters.abstract import AbstractPermissionConverter
from src.discord_template_manage.converters.permission import PermissionConverter
